...
import { personalInfo, experiences, education, certifications, skills, socialLinks } from '@/lib/portfolioData'
        ...
        <div id="resume-content" className="max-w-4xl mx-auto bg-white shadow-2xl rounded-lg overflow-hidden print:shadow-none">
          ...
          <div className="bg-gradient-to-r from-primary to-secondary text-white p-8">
            ...
            <div className="flex gap-4 mt-3 text-sm">
              {socialLinks.github && (
                <a href={socialLinks.github} className="flex items-center gap-1 hover:underline" target="_blank" rel="noopener noreferrer">
                  <FaGithub /> GitHub
                </a>
              )}
              {socialLinks.linkedin && (
                <a href={socialLinks.linkedin} className="flex items-center gap-1 hover:underline" target="_blank" rel="noopener noreferrer">
                  <FaLinkedin /> LinkedIn
                </a>
              )}
            </div>
